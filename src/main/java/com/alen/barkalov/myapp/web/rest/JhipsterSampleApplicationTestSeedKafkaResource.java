...
@RestController
@RequestMapping("/api/jhipster-sample-application-test-seed-kafka")
public class JhipsterSampleApplicationTestSeedKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationTestSeedKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleApplicationTestSeedKafkaResource(KafkaProperties kafkaProperties) {
