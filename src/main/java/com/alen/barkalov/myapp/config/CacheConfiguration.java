package com.alen.barkalov.myapp.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterSampleApplicationTestSeed");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterSampleApplicationTestSeed");
        ...
        config.getMapConfigs().put("com.alen.barkalov.myapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
