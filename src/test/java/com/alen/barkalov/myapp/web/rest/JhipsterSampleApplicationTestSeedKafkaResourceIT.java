...
import com.alen.barkalov.myapp.config.KafkaProperties;
...
class JhipsterSampleApplicationTestSeedKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleApplicationTestSeedKafkaResource kafkaResource = new JhipsterSampleApplicationTestSeedKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/jhipster-sample-application-test-seed-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/jhipster-sample-application-test-seed-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
